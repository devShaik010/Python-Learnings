...
isalnum()     to check if a string contains characters or digits and is not
empty
...
print(name) if name.isalpha() else print("Use only characters !")      

age = input("Enter your age : ")
print(age) if age.isalnum() else print("Use only numbers !")      